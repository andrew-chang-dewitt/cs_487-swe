...
The second case involves an Uber self‑driving car crash in Tempe, Arizona. During testing, the vehicle struck and killed a pedestrian after its perception system repeatedly misclassified her presence. The system cycled through labels such as "unknown object," "vehicle," and "bicycle," and never produced a stable prediction of danger. Emergency braking was disabled while the vehicle operated autonomously, and the human safety driver, who was expected to intervene when needed, was distracted. Neither the automated system nor the human supervisor recognized the hazard in time to prevent the collision :ref[ramachandran].

## Where automated awareness fails

Automated awareness systems struggle with several categories of failure. They cannot detect unfair outputs because fairness depends on social norms and legal standards rather than statistical patterns :ref[langer]. Automated tools operate on correlations and performance metrics, which means they cannot apply fairness criteria or recognize when a model reconstructs protected attributes through proxy variables, a pattern documented in real deployments :ref[ramachandran]. These systems also cannot determine when an output violates rights or ethical expectations because such judgments require human interpretation :ref[hwang]. Automated awareness further fails to recognize contextual errors that require domain knowledge or situational understanding. Monitoring tools can detect statistical deviations, yet they cannot determine whether those deviations matter in context or whether a technically plausible output is inappropriate for the situation :ref[langer, hwang]. Observability research shows that metrics can reveal anomalies, but they cannot explain their significance or evaluate whether an anomaly represents a meaningful risk :ref[gubkin]. Automated systems also cannot detect ethically significant harms, since these harms involve values, autonomy, or dignity rather than measurable features :ref[hwang]. Ethical evaluation requires an understanding of social meaning and potential consequences, and even safety‑focused architectures rely on human‑defined constraints because automated systems cannot determine what counts as harm :ref[phan]. Together, these limitations show that automated awareness can reveal patterns but cannot interpret their fairness, context, or ethical implications.
